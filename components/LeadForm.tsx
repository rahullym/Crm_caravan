...
export default function LeadForm({ formId, onSuccess, onCancel, onLoadingChange }: LeadFormProps) {
    ...
    <form id={formId} onSubmit={onSubmit}>
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <input name="name" type="text" required className="lead-form-input" placeholder="Full name" />
        </div>
        <div className="lead-form-field">
          <label className="lead-form-label">EMAIL</label>
          <input name="email" type="email" className="lead-form-input" placeholder="email@example.com" />
        </div>
      </div>
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <input name="phone" type="tel" className="lead-form-input" placeholder="04xx xxx xxx" />
        </div>
        <div className="lead-form-field">
          <label className="lead-form-label">STATE</label>
          <select name="state" className="lead-form-select">
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <select name="modelInterest" className="lead-form-select">
            <option value="">— Select —</option>
        ...
        <div className="lead-form-field">
          ...
          <input name="size" type="text" className="lead-form-input" placeholder="e.g. 21ft, 19'6ft" />
        </div>
      </div>
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <select name="source" className="lead-form-select">
            <option value="">— Select —</option>
        ...
        <div className="lead-form-field">
          ...
          <select name="status" className="lead-form-select">
            <option value="">— Select —</option>
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <select name="actionChannel" className="lead-form-select">
            <option value="">— Select —</option>
        ...
        <div className="lead-form-field">
          ...
          <select name="nextAction" className="lead-form-select">
            <option value="">— Select —</option>
      ...
      <div className="lead-form-row">
        <div className="lead-form-field">
          ...
          <input name="firstContactDate" type="date" className="lead-form-input" defaultValue={todayISO} />
        </div>
        <div className="lead-form-field">
          <label className="lead-form-label">NEXT ACTION DATE</label>
          <input name="nextActionDate" type="date" className="lead-form-input" />
        </div>
      </div>
